...
<p align="center">
  <img src="assets/code-evolve.gif" alt="AlphaEvolve iteratively rewriting code as it searches for a better algorithm" width="760">
  <br><em>AlphaEvolve rewriting code as it searches for better algorithms. Source: <a href="https://deepmind.google/blog/alphaevolve-a-gemini-powered-coding-agent-for-designing-advanced-algorithms/">Google DeepMind</a>.</em>
</p>
...
Gemini — `gemini-3.5-flash` and `gemini-3.1-pro-preview` — optionally blended as a weighted
mixture (`gemini-3.1-pro-preview` is served from the `global` location only).
